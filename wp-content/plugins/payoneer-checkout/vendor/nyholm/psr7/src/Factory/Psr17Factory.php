...
use Syde\Vendor\Nyholm\Psr7\ServerRequest;
use Syde\Vendor\Nyholm\Psr7\Stream;
use Syde\Vendor\Nyholm\Psr7\UploadedFile;
...
use Syde\Vendor\Psr\Http\Message\ServerRequestFactoryInterface;
...
use Syde\Vendor\Psr\Http\Message\UploadedFileFactoryInterface;
use Syde\Vendor\Psr\Http\Message\UploadedFileInterface;
