...
class BankAccountValidationApi
{
    ...
    public function bankAccountValidationRequestWithHttpInfo($accountValidationsRequest)
    {
        ...
        $modelClassLocation = explode('\\', '\CyberSource\Model\AccountValidationsRequest');
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    ...
                    break;
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse4033', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse4045', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse4222', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 502:
