...
class DeviceDeAssociationApi
{
     ...
     *
     * @param \CyberSource\Model\DeAssociationRequestBody $deAssociationRequestBody de association of the deviceId in the request body. (required)
    ...
    public function deleteTerminalAssociationWithHttpInfo($deAssociationRequestBody)
    {
        ...
        $modelClassLocation = explode('\\', '\CyberSource\Model\DeAssociationRequestBody');
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 401:
                    ...
                    break;
                case 403:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse4032', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 404:
                    ...
                    break;
                case 500:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse5003', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
    ...
    public function postDeAssociateV3TerminalWithHttpInfo($deviceDeAssociateV3Request)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $modelClassLocation = explode('\\', '\CyberSource\Model\DeviceDeAssociateV3Request[]');
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    ...
                    break;
                case 206:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse206[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\InlineResponse4008', $e->getResponseHeaders());
