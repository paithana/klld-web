...
class ConversionDetailsApi
{
    ...
    public function getConversionDetailWithHttpInfo($startTime, $endTime, $organizationId = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSource\Model\ReportingV3ConversionDetailsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\ReportingV3ConversionDetailsGet200Response', $e->getResponseHeaders());
