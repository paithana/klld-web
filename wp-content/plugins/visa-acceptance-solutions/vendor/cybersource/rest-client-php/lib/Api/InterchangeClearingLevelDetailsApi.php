...
class InterchangeClearingLevelDetailsApi
{
     ...
     * @return array of \CyberSource\Model\ReportingV3InterchangeClearingLevelDetailsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getInterchangeClearingLevelDetailsWithHttpInfo($startTime, $endTime, $organizationId = null)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSource\Model\ReportingV3InterchangeClearingLevelDetailsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\ReportingV3InterchangeClearingLevelDetailsGet200Response', $e->getResponseHeaders());
