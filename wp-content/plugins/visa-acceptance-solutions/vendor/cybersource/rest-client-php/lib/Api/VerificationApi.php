...
class VerificationApi
{
     ...
     *
     * @param \CyberSource\Model\ValidateExportComplianceRequest $validateExportComplianceRequest  (required)
     * @throws \CyberSource\ApiException on non-2xx response
     * @return array of \CyberSource\Model\RiskV1ExportComplianceInquiriesPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function validateExportComplianceWithHttpInfo($validateExportComplianceRequest)
    {
        ...
        $modelClassLocation = explode('\\', '\CyberSource\Model\ValidateExportComplianceRequest');
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSource\Model\RiskV1ExportComplianceInquiriesPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\RiskV1ExportComplianceInquiriesPost201Response', $e->getResponseHeaders());
     ...
     *
     * @param \CyberSource\Model\VerifyCustomerAddressRequest $verifyCustomerAddressRequest  (required)
     * @throws \CyberSource\ApiException on non-2xx response
     * @return array of \CyberSource\Model\RiskV1AddressVerificationsPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function verifyCustomerAddressWithHttpInfo($verifyCustomerAddressRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $modelClassLocation = explode('\\', '\CyberSource\Model\VerifyCustomerAddressRequest');
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSource\Model\RiskV1AddressVerificationsPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\RiskV1AddressVerificationsPost201Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\RiskV1DecisionsPost400Response1', $e->getResponseHeaders());
