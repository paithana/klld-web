...
class PaymentTokensApi
{
    ...
    public function retrieveOrDeletePaymentTokenWithHttpInfo($request)
    {
        ...
        $modelClassLocation = explode('\\', '\CyberSource\Model\Request');
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    ...
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\PtsV2RetrievePaymentTokenGet400Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 502:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSource\Model\PtsV2RetrievePaymentTokenGet502Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
