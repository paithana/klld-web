        ...
        <div id="tab-booking-detail" class="tab-pane fade active in">
            <div class="info">
                    <div class="row">
						...
						<?php
						$price_type = get_post_meta( $service_id, 'rental_price_by', true );
						...
						if ( $price_type == 'person' ) : ?>
							<div class="col-md-6">
								<div class="item_booking_detail">
									<strong><?php esc_html_e("Total Adult Price :",'traveler') ?> </strong>
							...
							<div class="col-md-6">
								<div class="item_booking_detail">
									<strong><?php esc_html_e("Total Child Price :",'traveler') ?> </strong>
