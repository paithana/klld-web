        ...
        <div class="hotel-target-book-mobile">
            ...
            if ($car_external == 'off' || empty($car_external)) {
                ...
                <a href="<?php echo esc_url($car_external_link); ?>"
                   class="btn"><?php echo esc_html__('Book Now', 'traveler') ?></a>
                <?php
            }
            ?>
        </div>
                                    ...
                                    <ul class="share-wrapper">
                                        ...
                                        <li><a class="twitter"
                                               ...
                                               target="_blank" rel="noopener" original-title="Twitter"><i
                                                        class="fa fa-x-twitter fa-lg"></i></a></li>
                                    ...
                                    <div class="form-book-wrapper relative">
                                        ...
                                        <nav>
                                            <ul class="nav nav-tabs nav-fill-st" id="nav-tab" role="tablist">
                                                <li class="active"><a id="nav-book-tab" data-bs-toggle="tab" href="#nav-book" role="tab" aria-controls="nav-home" aria-selected="true"><?php echo esc_html__( 'Book', 'traveler' ) ?></a></li>
                                            ...
                                            if($enable_inbox === 'on'){ ?>
                                                <div class="st_ask_question">
                                                    <?php
                                                        ...
                                                        <a href="" class="login btn btn-primary upper mt5" data-bs-toggle="modal" data-target="#st-login-form"><?php echo __('Ask a Question', 'traveler');?></a>
                                                    <?php } else{?>
