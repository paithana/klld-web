...
<div id="st-content-wrapper" class="st-page-default">
	...
	$role_names   = (array) $current_user->roles;
	$is_main_role = in_array( 'administrator', $role_names ) || in_array( 'partner', $role_names );
    ?>
                ...
                <div class="container">
                    <div class="col-12 col-sm-8">
                        <div class="alert alert-danger">
                            <p><?php esc_html_e('You need to login as admin or partner to checkout.','traveler') ?></p>
                        </div>
                    </div>
                </div>
            </div>
