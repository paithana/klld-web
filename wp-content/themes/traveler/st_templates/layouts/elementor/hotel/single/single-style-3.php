		...
		<?php st_breadcrumbs_new() ?>
			...
			if ( ! wp_is_mobile() ) {
				...
				if ( $google_api_key === 'on' ) {
					?>
						<div class="st-map d-none d-sm-block">
					...
					<div class="col-xs-12 col-md-9 ">
						<div class="st-hotel-content">
							<div class="hotel-target-book-mobile d-flex justify-content-between align-items-center">
								...
								<a href=""
								class="btn btn-mpopup"><?php echo esc_html__( 'Check Availability', 'traveler' ) ?></a>
							</div>
						</div>
			...
			if ( $st_show_hotel_nearby == 'on' && ! empty( ! empty( $nearby_posts ) ) ) {
				?>
				<div class="container">
						...
						<div class="row service-list-wrapper">
							...
							if ( $nearby_posts ) {
								foreach ( $nearby_posts as $key => $post ) {
									...
									echo st()->load_template( 'layouts/elementor/hotel/loop/normal-grid', '', [ 'item_row' => 4 ] );
								}
								wp_reset_query();
								wp_reset_postdata();
							}
