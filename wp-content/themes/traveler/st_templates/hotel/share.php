...
<div class="share clear">
    <span><?php st_the_language('share')?><i class="fa fa-share fa-lg"></i></span>
        ...
        <li><a class="twitter" href="https://x.com/share?url=<?php the_permalink() ?>&amp;title=<?php the_title()?>" target="_blank" rel="noopener" original-title="Twitter"><i class="fa fa-x-twitter fa-lg"></i></a></li>
