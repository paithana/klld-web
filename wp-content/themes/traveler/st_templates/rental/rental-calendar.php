        ...
        <div class="form-content clearfix">
			...
			<div class="row" style="margin-bottom: 15px">
				<div class="col-xs-12 col-md-6 col-lg-4">
					<label for="booking-min-day-bulk"><strong><?php echo __('Minimum stay', 'traveler'); ?></strong></label>
					<input type="number" name="booking-min-day-bulk" id="booking-min-day-bulk" class="form-control" placeholder="">
				</div>
			</div>
