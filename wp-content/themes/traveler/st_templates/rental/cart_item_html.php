...
<div class="booking-item-payment-total text-right">
    <?php
    $item_price = STPrice::getRentalPriceOnlyCustomPrice($item_id, strtotime($check_in), strtotime($check_out), $adult_number, $child_number);
    $price =  $item_price;
    $sale_price = STPrice::getSalePrice($item_id, strtotime($check_in), strtotime($check_out), $adult_number, $child_number);
