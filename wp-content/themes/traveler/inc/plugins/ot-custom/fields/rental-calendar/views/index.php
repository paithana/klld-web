    ...
    <div class="col-xs-12 col-lg-4">
        ...
        <div class="calendar-form">
			...
			<div class="row">
				<div class="col-xs-12 col-md-6 col-lg-4">
					<div class="form-group">
						<label for="calendar_booking_min_day"><?php echo __('Minimum stay', 'traveler'); ?></label>
						<input type="number" name="calendar_booking_min_day" id="calendar_booking_min_day" class="form-control" placeholder="">
					</div>
				</div>
			</div>
