...
<div class="item-room loop-room post-<?php the_ID() ?> loop-room-style-1">
    ...
    <div class="room-book">
        ...
        <form class="form-booking-inpage hotel-alone-booking-inpage" class="" method="post">
            ...
            <input type="hidden" name="room_num_search" value="<?php echo esc_attr( STInput::request('room_number', 0) ); ?>"/>

            <input type="hidden" name="adult_number" value="<?php echo esc_attr( STInput::request('adults', 0) ); ?>"/>

            <input type="hidden" name="child_number" value="<?php echo esc_attr( STInput::request('children', 0) ); ?>"/>
