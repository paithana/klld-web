...
<div class="st-share <?php echo esc_attr($extra_class) ?>">
    ...
    <ul class="list-social">
        ...
        <li><a class="wb-twitter" href="http://x.com/share?url=<?php the_permalink() ?>&amp;title=<?php echo urlencode(get_the_title())?>" target="_blank" title="<?php esc_html_e("Twitter",'heliospress') ?>"><i class="fa fa-twitter fa-lg"></i></a></li>
