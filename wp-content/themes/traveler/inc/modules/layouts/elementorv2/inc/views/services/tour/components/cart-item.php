        ...
        <?php if($tour_price_by != 'fixed_depart'){ ?>
            ...
            <?php else: ?>
                ...
                <span class="label">
                    ...
                    <span class="value">
                        <?php echo date_i18n( TravelHelper::getDateFormat(), strtotime( $check_in ) );
                        $time_checkin =  strtotime(date(TravelHelper::getDateFormat(), strtotime($check_in)));
...
<div class="coupon-section">
    ...
    <div class="coupon-section-wrap">
        ...
        <div class="form-group">
            ...
            <?php }else{ ?>
                <button type="submit" class="btn btn-primary wp-block-search__button coupon-ajax"><?php echo __('APPLY', 'traveler'); ?></button>
            <?php } ?>
        </div>
	</div>
</div>
<div class="total-section">
    ...
    $price_with_tax = STPrice::getPriceWithTax($origin_price + $extra_price + $hotel_package_price + $activity_package_price + $car_package_price + $flight_package_price);
    ...
    <ul>
		...
		<?php
        	$total_bulk_discount = !empty($data_price['total_bulk_discount']) ? floatval($data_price['total_bulk_discount']): 0;
