...
$review_rate = STReview::get_avg_rate($post_translated);
...
?>
<div class="services-item list item-elementor" itemscope itemtype="https://schema.org/Hotel" data-id="<?php echo esc_attr($post_id); ?>">
        ...
        <div class="content-item">
            ...
            <div class="section-footer">
                <div class="reviews" itemprop="starRating" itemscope itemtype="https://schema.org/Rating">
                    ...
                    <span class="summary">
                        (<?php comments_number(esc_html__('No Review', 'traveler'), esc_html__('1 Review', 'traveler'), get_comments_number($post_translated) . ' ' . esc_html__('Reviews', 'traveler'), $post_translated ); ?>)
                    </span>
                </div>
