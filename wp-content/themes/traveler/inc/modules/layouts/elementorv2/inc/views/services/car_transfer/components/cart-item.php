    ...
    if (isset($item_id) and $item_id):
        ...
        <div class="info-section">
            <ul>
                ...
                if (!empty($item_id['data']['extras']) && $item_id['data']['extra_price']){ ?>
                    <li>
                ...
                if(isset($passengers) && $passengers > 0 ){ ?>
                    <li>
               		...
               		<?php }
					$price_type = get_post_meta( $id_car, 'price_type', true );
					$price_unit = '';
					switch ($price_type) {
						case 'distance':
                    ...
                    if(!empty($time[ 'distance' ])){
                        ...
                        <span class="value">'.TravelHelper::format_money($item_id['data']['price']). $price_unit . '</span>
                        </li>';
                    }
                    if($item_id['data']['has_return'] === 'yes'){
                        ...
                        echo '<li>
                            ...
                            <span class="value">'.TravelHelper::format_money($item_id['data']['price_return']). $price_unit . '</span>
                        </li>';
                    }
            ...
            <form method="post" action="<?php the_permalink() ?>">
                ...
                <div class="form-group">
                    ...
                    <?php if (st()->get_option('use_woocommerce_for_booking', 'off') == 'off' && st()->get_option('booking_modal', 'off') == 'on') { ?>
                        ...
                        <button type="submit"
                                class="btn btn-primary add-coupon-ajax wp-block-search__button"><?php echo __('APPLY', 'traveler'); ?></button>
        ...
        <div class="total-section">
            <ul>
                <?php
                    if($item_id['data']['discount_rate'] > 0){ ?>
                        <li>
                            <span class="label"><?php echo __('Discount', 'traveler'); ?></span>
                            <span class="value"><?php
                            echo $item_id['data']['discount_rate'] .'%' ?></span>
                        </li>
                    <?php }
                ?>
                <li>
                ...
                <?php if ($item_id['data']['extra_price']): ?>
                    <li>
                        <span class="label"><?php echo __('Extra Price ', 'traveler'); ?></span>
                        <span class="value"><?php echo TravelHelper::format_money($item_id['data']['extra_price']) ?></span>
                    </li>
                <?php endif; ?>
                <?php
                ...
                <?php if (isset($item_id['data']['booking_fee_price'])):
					...
					$total_price += $item_id['data']['booking_fee_price'];
                    ?>
                    <li>
