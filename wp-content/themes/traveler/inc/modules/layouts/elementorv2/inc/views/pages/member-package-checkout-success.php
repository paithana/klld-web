                    ...
                    <div class="col-md-12 col-lg-8">
                        <div class="d-flex align-items-center st-notice-success">
                            ...
                            <div class="title-admin">
                                <p class="st-admin-success"><?php $userdata = get_userdata( $get_order_by_token->partner );echo !empty($userdata->user_login) ? esc_html($userdata->user_login) : '' ; echo ', ';?> <span><?php echo __('Your order was submitted' , 'traveler' );?></span></p>
                                <p class="st-text">
                                    <?php echo __('Details have been sent to: ', 'traveler' );
                                    $partner_info = unserialize($get_order_by_token->partner_info, [ 'allowed_classes' => false ]);
                        ...
                        <div class="sidebar-order">
                            <ul class="list-unstyled st-list-sider-info">
                                ...
                                <li>
                                    ...
                                    <p><span><strong><?php echo date(TravelHelper::getDateFormat(), $get_order_by_token->created); ?></strong></span></p>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>
										...
										if ( $status == 'incomplete' ) {
											echo '<span class="order-status warning">' . __( 'incomplete', 'traveler' ) . '</span>';
										} elseif ( $status == 'completed' ) {
											echo '<span class="order-status success">' . __( 'completed', 'traveler' ) . '</span>';
										} elseif ( $status == 'cancelled' ) {
											echo '<span class="order-status danger">' . __( 'cancelled', 'traveler' ) . '</span>';
										} elseif ( $status == 'pending' ) {
											echo '<span class="order-status warning"><strong>' . __( 'pending', 'traveler' ) . '</strong></span>';
										}
										?>
                    ...
                    <div class="st-title-yourinfor">
                        ...
                        <div class="st-table-infor">
                            ...
                            if( !empty($partner_info) ):
                                $partner_info = unserialize($partner_info, [ 'allowed_classes' => false ]);?>
                        ...
                        <div class="cart-content">
                            ...
                            <div class="item">
                                ...
                                <span class="pull-right">
									<?php
									if ( $get_order_by_token->package_item_upload === 'unlimited' ) {
										echo esc_html__( 'Unlimited', 'traveler' );
									} else {
										echo esc_html( $get_order_by_token->package_item_upload );
									}
									?>
								</span>
                            </div>
                            <div class="item">
                                ...
                                <span class="pull-right">
									<?php
									if ( $get_order_by_token->package_item_featured === 'unlimited' ) {
										echo esc_html__( 'Unlimited', 'traveler' );
									} else {
										echo esc_html( $get_order_by_token->package_item_featured );
									}
									?>
								</span>
                            </div>
