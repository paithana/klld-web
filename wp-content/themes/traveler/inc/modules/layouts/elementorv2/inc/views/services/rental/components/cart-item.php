...
if(isset($item_id) and $item_id):
    ...
    $discount_rate = isset($item['data']['discount_rate']) ? $item['data']['discount_rate'] : 0;
...
<div class="coupon-section">
    ...
    $origin_price=STPrice::getRentalPriceOnlyCustomPrice($room_id, strtotime($check_in), strtotime($check_out), $adult_number, $child_number);
	...
	$price_type = get_post_meta( $room_id, 'rental_price_by', true );
    ?>
