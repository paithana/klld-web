...
class ST_Admin_Settings extends STAdmin
{
    ...
    public function __apiConfigureSettings()
    {
        return apply_filters('api_configure_setting', [
            ...
            [
                ...
                'type' => 'select',
				'desc' => esc_html__('The setting will be applied when you do not configure TravelPayouts Whitelabel', 'traveler'),
                'operator' => 'and',
			...
			[
                ...
                'type' => 'on-off',
				'desc' => esc_html__('To use the TravelPayout Whitelabel function, you are required to purchase the TravelPayouts Plan independently', 'traveler'),
                'section' => 'option_api_update',
                'std' => 'off'
            ],
            [
                'id' => 'tp_whitelabel',
                'label' => esc_html__('Whitelabel Subdomain', 'traveler'),
                'type' => 'text',
                'section' => 'option_api_update',
    ...
    public function __emailPartnerSettings()
    {
        return [/* ------------- Email Partner Template -------------------- */
            ...
            [
                ...
                'type' => 'post-select-ajax',
                'desc' => __('Email need approval. (Title: New Register Partner...)', 'traveler'),
            ...
            [
				...
				'desc' => 'Title: New User Registration...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
				...
				'desc' => 'Title: Your partner registration...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
                ...
                'type' => 'post-select-ajax',
				'desc' => 'Title: Your Partner Registration has been approved...',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ],
            [
				...
				'desc' => 'Title: Partner Registration Has Been Cancel...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
				...
				'desc' => 'Title: Your Request Withdrawal...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
				...
				'desc' => 'Title: Approved Request Withdrawal...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
				...
				'desc' => 'Title: Cancel Request Withdrawal...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
				...
				'desc' => 'Title: Have new a member package...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
            ...
            [
				...
				'desc' => 'Title: You have registed a member package...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_partner',
    ...
    public function __partnerSettings()
    {
		...
		$custom_partner_settings = apply_filters( 'st_custom_partner_settings_general', [] );
        ...
        return [/* ------------- Option Partner Option -------------------- */
            ...
            [
                ...
                'label' => __('Show adminbar in User Dashboard', 'traveler'),
                'type' => 'on-off',
                'section' => 'option_partner',
                'std' => 'off'
            ],
    ...
    public function __tourSettings()
    {
		...
		$tour_form_fields   = [];
		if ( $style_page_builder === 'wp_page_builder' ) {
			$tour_form_fields = [
				'id' => 'tour_form_fields',
                'label' => __('Setting Form Field(Only use for WPBakery Page Builder element [ST] Slider Tour With Search Form style 2)', 'traveler'),
        ...
        return [
			...
			[
                'id' => 'enable_email_after_finish_tour',
                'label' => esc_html__('Automated email sent after 1 day finish tour', 'traveler'),
                'desc' => esc_html__('Automated email sent after 1 day finish tour', 'traveler'),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_activity_tour',
            ],
			[
                'id' => 'email_after_finish_tour',
                'label' => __('Email template sent after 1 day finish tour.', 'traveler'),
				'desc' => 'Title: Thanks for ...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_activity_tour',
				'condition' => 'enable_email_after_finish_tour:is(on)',
            ],
        ];
    }
    ...
    {
		$email_customer_template_settings = apply_filters( 'email_customer_template_settings', [] );
		$email_partner_template_settings = apply_filters( 'email_partner_template_settings', [] );
        return [/* -------------Email Template ---------------- */
            ...
            [
				...
				'desc' => 'Title: Notification expired membership package...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
            ],
			$email_partner_template_settings,
            ...
            [
				...
				'desc' => 'Title: Notification about departure date of service...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
			...
			[
                'id' => 'register_email_for_customer',
                'label' => __('Email to normal customer (when register)', 'traveler'),
				'desc' => 'Title: Your account at ...',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
            ],
			$email_customer_template_settings,
            ...
            [
				...
				'desc' => 'Title: Confirmation needed.',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
            ...
            [
				...
				'desc' => 'Title: Service pending approval on your website.',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
            ...
            [
				...
				'desc' => 'Title: You have a request for cancel booking.',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
            ...
            [
				...
				'desc' => 'Title: Cancel booking of your customer is completed.',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
            ...
            [
				...
				'desc' => 'Title: Your request cancel booking is completed.',
                'type' => 'post-select-ajax',
                'post_type' => 'st_template_email',
                'sparam' => 'page',
                'section' => 'option_email_template',
    ...
    {
		$email_settings = apply_filters( 'st_email_settings', [] );
        return [
            /* ------------ Begin Email Option -------------- */
    ...
    public function __advanceSettings()
    {
        return [
			...
			[
                'id' => 'adv_inside_body_content',
                'label' => __('Inside body tag Content', 'traveler'),
    ...
    public function __blogSettings()
    {
        ...
        return [
            ...
            [
                ...
                'desc' => __('Choose the blog style (default is Style 1). Select the 2nd blog style (Solo Style) only when using the 5th header style (Solo Header).', 'traveler'),
                'type' => 'radio-image',
                'section' => 'option_blog',
                'std' => '1',
			...
			[
                ...
                'choices' => [
                    [
                        'label' => __('Default Style(Modern if Bloglist Modern Style)', 'traveler'),
                        'value' => '1'
                    ],
                    [
                        'label' => __('Solo Style (only for header style 5 Solo)', 'traveler'),
                        'value' => '2'
                    ]
                ],
				'std' => '1'
    ...
    public function __bookingSettings()
    {
        $r = [
            ...
            [
                ...
                'label' => __('Google reCAPTCHA On Checkout Page', 'traveler'),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_booking',
                'desc' => __('Only use for checkout page', 'traveler'),
            ],
			[
                'id' => 'login_register_enable_captcha',
                'label' => __('Google reCAPTCHA On Login/Register', 'traveler'),
                'type' => 'on-off',
                'std' => 'off',
                'section' => 'option_booking',
                'desc' => __('Use for login, register', 'traveler'),
            ],
            [
                'id' => 'st_site_key_captcha',
                'label' => __('Site key', 'traveler'),
                'desc' => __('Use this Google reCAPTCHA V3 site key in the HTML code your site serves to users. : https://travelerwp.com/create-google-recaptcha-key', 'traveler'),
                'type' => 'text',
                'section' => 'option_booking',
			...
			[
                'id' => 'use_st_form_builder',
                'label' => __('ST Form Builder: Select form for checkout template', 'traveler'),
                'desc' => __('Leave none to default field', 'traveler'),
                'type' => 'select',
                'section' => 'option_booking',
				'choices' => wb_get_all_form(),
                'std' => 'none'
            ],
            [
                'id' => 'woocommerce_tab',
    ...
    {
		$custom_hotel_settings = apply_filters( 'st_custom_hotel_settings', [] );
        $r = [
            /* ------------- Hotel Option -------------- */
            [
                'id' => 'disable_availability_check',
                'label' => esc_html__('Disable Availability Check', 'traveler'),
			...
			array(
                'id' => 'hotel_max_room',
                'label' => __('Max Rooms in search field of Hotel', 'traveler'),
                'desc' => __('Select max Rooms for search field', 'traveler'),
                'type' => 'text',
                'section' => 'option_hotel',
                'std' => 14
            ),
			$custom_hotel_settings
            /* ------------- End Hotel Option -------------- */
        ];
    ...
    public function getAllSettings()
    {
        $allSetings = [
            ...
            [
                ...
                'title' => __('<i class="fa fa-building"></i> Single Hotel Options', 'traveler'),
    ...
    public function __styleSettings()
    {
        ...
        return [
            ...
            [
                'id' => 'option_style_item_author_page',
                'label' => __('Style item author page', 'traveler'),
                'desc' => __('Style for All services in Author page', 'traveler'),
                'type' => 'select',
                'section' => 'option_style',
                'choices' => [
                    [
                    ...
                    [
                        'value' => 'mod',
                        'label' => __('Mod', 'traveler')
                    ]
                ],
                'std' => 'default',
                'condition' => 'option_style_page_builder:is(elementor)'
            ],
            [
                'id' => 'right_to_left',
			...
			[
                ...
                'label' => __('Sticky header Background Color', 'traveler'),
                'desc' => __('To change the background color for Sticky header', 'traveler'),
                'type' => 'colorpicker',
                'section' => 'option_style',
				'condition' => 'gen_enable_sticky_header:is(on)',
                'std' => '#999999',
            ],
			[
                'id' => 'sticky_header_mb_bg_color',
                'label' => __('Sticky header Background Color for mobile', 'traveler'),
                'desc' => __('To change the background color mobile for Sticky header', 'traveler'),
                'type' => 'colorpicker',
                'section' => 'option_style',
				'condition' => 'gen_enable_sticky_header:is(on)',
                'std' => '#999999',
            ...
            [
                ...
                'desc' => __('Enable Mega Menu - Build with WPBakery / Elementor', 'traveler'),
                'type' => 'on-off',
                'section' => 'option_style',
                'std' => 'on',
            ...
            [
                ...
                'settings' => [
					...
					[
                        ...
                        'label' => __('Shortcode', 'traveler'),
                        'type' => 'text',
						'desc' => __('Example: [your-shortcode]', 'traveler'),
                        'condition' => 'topbar_item:is(shortcode)'
                    ],
                ],
            ],
            [
            ...
            [
                ...
                'desc' => __("Copyright text. This text will only display when no Page Options > Modern Footer Page is selected.", 'traveler'),
                'type' => 'textarea-simple',
                'section' => 'option_style',
                'class' => '',
            ...
            [
                ...
                'desc' => __("Card Accept. This text will only display when no Page Options > Modern Footer Page is selected.", 'traveler'),
                'type' => 'upload',
                'section' => 'option_style',
                'class' => '',
    ...
    public function __generalSettings()
    {
        return [
            ...
            [
                ...
                'desc' => __('Change Logo. Please also upload to Appearance > Customize > Site Identity > Logo. For site icon, upload Appearance > Customize > Site Identity > Site Icon', 'traveler'),
                'type' => 'upload',
                'section' => 'option_general',
            ],
            [
            ...
            [
                ...
                'section' => 'option_general',
                'std' => '',
                "desc" => __("Change Logo Mobile. Please also upload to Appearance > Customize > Site Identity > Logo Mobile", 'traveler')
            ],
            [
                'id' => '404_tab',
