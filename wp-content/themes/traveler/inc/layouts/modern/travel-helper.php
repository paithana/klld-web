...
if (!class_exists('TravelHelper')) {
    ...
    class TravelHelper {
        ...
        public static function add_menu_below($nav_menu, $args) {
            ...
            if ( ($menu_style == '1' || $menu_style == '2' || $menu_style == '3') && !is_user_logged_in() && $args->theme_location == 'primary') {
			...
			if ( ($menu_style == '1' || $menu_style == '2' || $menu_style == '3') && is_user_logged_in() && $args->theme_location == 'primary') {
                ...
                $nav_menu = substr($nav_menu, 0, -5);
                $nav_menu .= '<li class="topbar-item account-dashboard-item">
                <a href="'. esc_url( get_the_permalink( $account_dashboard ) ) .'" class="account-dashboard">' . esc_html__('Your Dashboard', 'traveler') . '</a>
            	</li>' . '<li class="topbar-item signout-item">
                    <a href="' . wp_logout_url() . '" class="signout">' . esc_html__('SignOut', 'traveler') . '</a>
                </li>';
                $nav_menu .= '</ul>';
            }
        ...
        static function get_currency_cookie() {
            return isset( $_COOKIE['currency'] ) ? unserialize(stripslashes(gzuncompress(base64_decode($_COOKIE['currency']))), [ 'allowed_classes' => false ]) : false;
        }
        ...
        static function st_approved_item($author, $post) {
            ...
            $subject = __('Service pending approval on your website.', 'traveler');
