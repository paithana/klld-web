...
if(check_using_elementor()){
    $array_elementor = [
        ...
        [
            ...
            'src' => get_template_directory_uri() . '/v2/images/layouts/hotel_detail_4_preview.jpg',
        ],
        [
            'value' => '5',
            'label' => esc_html__('Layout 5', 'traveler'),
            'src' => get_template_directory_uri() . '/v2/images/layouts/hotel_detail_5_preview.png',
        ],
    ];
    $layout_single_hotel = array_merge($layout_single_hotel,$array_elementor);
}


$layout_single_hotel = apply_filters('st_layout_single_hotel',$layout_single_hotel);
//End layout hotel
...
$layout_room_single = apply_filters('st_layout_single_room',$arr_layout_room);
//End layout room

//Layout rental
$layout_rental_single = [
    [
        'value' => '1',
        'label' => esc_html__( 'Layout 1', 'traveler' ),
        'src'   => get_template_directory_uri() . '/v2/images/layouts/room_detail_2_preview.jpg',
...
if(check_using_elementor()){
    ...
    $layout_rental_single = array_merge($layout_rental_single,$array_rental_elementor);
}
$layout_rental_single = apply_filters('st_layout_single_rental',$layout_rental_single);
...
if(check_using_elementor()){
    $array_car_elementor = [
        [
            'value' => '2',
            'label' => esc_html__('Layout 2', 'traveler'),
            'src' => get_template_directory_uri() . '/v2/images/layouts/car_layout_2.png',
        ],
        [
            'value' => '3',
            'label' => esc_html__('Layout 3', 'traveler'),
            'src' => get_template_directory_uri() . '/v2/images/layouts/car_layout_3.png',
        ],
    ];
    $layout_car_single = array_merge($layout_car_single,$array_car_elementor);
}
$layout_car_single = apply_filters('st_layout_single_car',$layout_car_single);
//End Layout Car Single

$new_layout = st()->get_option('st_theme_style', 'modern');

$hotel_partner_set_external_link = st()->get_option( 'partner_set_external_link', 'off' );
$hotel_external_booking          = [];
$hotel_external_booking_link     = [];
if ( st()->get_option( 'partner_set_external_link', 'off' ) == 'on' ) {
	$hotel_external_booking = [
		'type'     => 'select',
		'label'    => __( 'External Booking', 'traveler' ),
		'name'     => 'st_hotel_external_booking',
		'col'      => '4',
		'plh'      => '',
		'required' => false,
		'options'  => [
	...
	$hotel_external_booking_link = [
		...
		'name'      => 'st_hotel_external_booking_link',
		'col'       => '4',
		'plh'       => '',
		'required'  => true,
		'condition' => 'st_hotel_external_booking:is(on)',
	];
}
        ...
        'add' => array(
            'hotel' => array(
                ...
                'content' => apply_filters('st_partner_hotel_content',
                    array(
                        'basic_info' => apply_filters( 'st_partner_hotel_basic_info', array(
                            array(
                                'type' => 'group',
                        ...
                        'locations' => array(
                            array(
                                ...
                                'name' => 'multi_location',
                                'col' => '6',
                                'plh' => __('SEARCH LOCATION', 'traveler'),
                                'required' => true
                            ),
                            array(
            ...
            'room' => array(
                ...
                'content' => apply_filters('st_partner_hotel_room_content',
                    array(
                        ...
                        'prices' => apply_filters( 'st_partner_room_prices', array(
                            array(
                                'type' => 'select',
                            ...
                            array(
                                'type' => 'select',
                                'label' => __('Disable "Adult Name Required"', 'traveler'),
                                'name' => 'disable_adult_name',
                                'col' => '4',
                                'plh' => '',
                                'clear' => true,
                                'options' => array(
                            ...
                            array(
                                'type' => 'select',
                                'label' => __('Disable "Children Name Required"', 'traveler'),
                                'name' => 'disable_children_name',
                                'col' => '4',
                                'plh' => '',
                                'required' => false,
                                'options' => array(
            ...
            'tour' => array(
                ...
                'content' => apply_filters('st_partner_tour_content',
                    array(
                        'basic_info' => apply_filters( 'st_partner_tour_basic_info', array(
                            array(
                                'type' => 'group',
                                'label' => __('PERSONAL INFORMATION', 'traveler'),
                                'col' => '12',
                        ...
                        'prices' => apply_filters( 'st_partner_tour_price', array(
                            array(
                                'type' => 'select',
                            ...
                            array(
                                'type' => 'select',
                                'label' => __('Disable "Infant Name Required"', 'traveler'),
                                'name' => 'disable_infant_name',
                                'col' => '4',
                                'plh' => '',
                                'required' => false,
                                'options' => array(
                        ...
                        'locations' => apply_filters( 'st_partner_tour_locations', array(
                            array(
                                'type' => 'multi_location',
            ...
            'activity' => array(
                ...
                'content' => apply_filters('st_partner_activity_content',
                    array(
                        ...
                        'prices' => apply_filters( 'st_partner_activity_price', array(
                            array(
                                'type' => 'number',
                                'label' => __('Adult price' . apply_filters( 'st_partner_price_title', '' ), 'traveler'),
                                'name' => 'adult_price',
                                'col' => '4',
                                'plh' => '',
                                'required' => true,
                            ...
                            array(
                                'type' => 'number',
                                'label' => __('Child price' . apply_filters( 'st_partner_price_title', '' ), 'traveler'),
                                'name' => 'child_price',
                                'col' => '4',
                                'plh' => '',
                                'required' => true
                            ...
                            array(
                                'type' => 'number',
                                'label' => __('Infant price' . apply_filters( 'st_partner_price_title', '' ), 'traveler'),
                                'name' => 'infant_price',
                                'col' => '4',
                                'plh' => '',
                                'required' => true
                        ...
                        'locations' => apply_filters( 'st_partner_activity_location', array(
                            array(
                                'type' => 'multi_location',
                ...
                'content' => apply_filters('st_partner_car_content',
                    array(
                        ...
                        'prices' => apply_filters( 'st_partner_car_prices', array(
							...
							array(
								'type' => 'text',
								'label' => __('No. Passengers for transfer', 'traveler'),
								'name' => 'num_passenger',
								'col' => '4',
								'plh' => '',
								'condition' => 'car_type:is(car_transfer)',
							...
							array(
								'type' => 'list-item',
								'label' => __('Customize Price by Date', 'traveler'),
								'name' => 'price_by_date',
								'col' => '6',
								'plh' => '',
								'text_add' => __('Add New', 'traveler'),
								'condition' => 'car_type:is(normal),is_custom_price:is(price_by_date)',
								'operator' => 'and',
								'fields' => array(
									array(
										'type' => 'datepicker',
							...
							array(
								'type' => 'list-item',
								'label' => __('Customize price by number of day/hour', 'traveler'),
							...
							array(
								'type' => 'list-item',
								'label' => __('Equipment price (If service is car transfer, price type is fixed only)', 'traveler'),
								'name' => 'extra_price',
								'col' => '6',
								'plh' => '',
								'text_add' => __('Add New', 'traveler'),
                    ...
                    array(
                        'basic_info' => apply_filters( 'st_partner_rental_basic_info', array(
                                ...
                                array(
                                    ...
                                    'name' => 'rental_single_layout_v2',
                                    'col' => '12',
                                    'plh' => '',
                                    'choices' => $layout_rental_single,
                                    'std'     => '1',
                                    'seperate' => true
                                ),
                                array(
                                ...
                                array(
                                    'type' => 'text',
                                    'label' => __('Size of Area', 'traveler'),
                                    'name' => 'rental_size',
                                    'col' => '4',
                                    'plh' => '',
                                    'required' => true
                        ...
                        'prices' => array(
                            ...
                            array(
                                'type' => 'select',
                                'label' => __('Discount type (Discount rate by)', 'traveler'),
                                'name' => 'discount_type',
                                'col' => '4',
                                'plh' => '',
                                'required' => false,
                            ...
                            array(
                                'type' => 'select',
                                'label' => __('Discount Type for No.Day', 'traveler'),
                                'name' => 'discount_type_no_day',
                                'col' => '6',
                                'plh' => '',
                                'required' => false,
