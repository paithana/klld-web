						...
						<div class="postbox">
							...
							<div class="inside">
								...
								if ( $price_type == 'person' ) : ?>
									<div class="form-row">
										<label class="form-label" for=""><?php _e('Total Adult Price','traveler')?></label>
										<div class="controls">
										<?php
									...
									<div class="form-row">
										...
										<label class="form-label" for=""><?php _e('Total Child Price','traveler')?></label>
								...
								<?php
								st_admin_print_order_item_guest_name([
