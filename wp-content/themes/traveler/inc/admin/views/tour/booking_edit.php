                ...
                <form method="post" action="" id="form-booking-admin">
                    ...
                    <div id="poststuff">
                        <div class="postbox">
                            ...
                            <div class="inside">
                                <div class="form-row">
                                    <label class="form-label" for=""><?php _e( 'Booker Email', 'traveler' ) ?><span
								...
								<?php
								// Pickup location
								$pickup = get_post_meta( $item_id, 'pickup', true );
								if ( $pickup ) {
									?>
									<div class="form-row">
                                        <label class="form-label"><?php _e( 'Pick up', 'traveler' ) ?></label>
                                        <div class="controls">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
										...
										<input type="hidden" name="adult_number" value="<?php echo esc_attr($adult_number); ?>">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <label class="form-label"
                                    ...
                                    <div class="controls">
										...
										<input type="hidden" name="child_number" value="<?php echo esc_attr($child_number); ?>">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="controls">
										...
										<input type="hidden" name="infant_number" value="<?php echo esc_attr($infant_number); ?>">
