...
<div class="woocommerce-checkout-review-order-table booking-item-payment">
    ...
    foreach (WC()->cart->get_cart() as $cart_item_key => $cart_item) {
        ...
        if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_checkout_cart_item_visible', TRUE, $cart_item, $cart_item_key)) {
            ...
            <?php 
            // Display booking details for each item
            if (isset($cart_item['st_booking_data']) && !empty($cart_item['st_booking_data'])) {
                ...
                if ($post_type && $booking_id) {
                    // Use action hook to display booking information
                ...
                <?php if ( wc_tax_enabled() && ! WC()->cart->display_prices_including_tax() ) : ?>
                    ...
                    <?php else : ?>
                        <li class="tax-total">
                            ...
                            <p class="booking-item-payment-price-amount"><?php wc_cart_totals_taxes_total_html(); ?></p>
                        </li>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
