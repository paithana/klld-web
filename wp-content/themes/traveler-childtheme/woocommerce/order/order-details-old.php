                                    ...
                                    <?php
                                        if ( $_product && !$_product->is_visible() ) {
                                            if($post_type == "car_transfer"){
                                                $transfer_title = wc_get_order_item_meta( $item_id, '_st_title_cart', true );
                                                echo apply_filters( 'woocommerce_order_item_name', $transfer_title, $item );;
                                            }
                                            else{
                                            ...
                                            if($post_type == "car_transfer"){
                                                $transfer_title = wc_get_order_item_meta( $item_id, '_st_title_cart', true );
                                                echo apply_filters( 'woocommerce_order_item_name', sprintf( '<a href="%s">%s</a>', get_permalink( $st_booking_id ), $transfer_title ), $item );
                                            }
                                            else{
