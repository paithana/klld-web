...
if ( ! empty( $tour_programs ) ) {
	...
	<div class="st-program-list">
		...
		foreach ( $tour_programs as $k => $v ) {
			...
			?>
			<div class="accordion faq st-program style1" id="accordion_<?php echo esc_attr( $section_id ); ?>" name="tours_program">
				<div class="accordion-item">
					<h3 class="accordion-header" id="heading_<?php echo esc_attr( $section_id ); ?>">
