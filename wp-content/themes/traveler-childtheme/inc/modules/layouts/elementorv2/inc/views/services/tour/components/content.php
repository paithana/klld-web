...
<div class="col-sm-12 col-md-9 col-lg-9">
    <?php echo stt_elementorv2()->loadView('services/tour/components/toolbar', ['style' => $style, 'has_filter' => true, 'post_type' => 'st_tours', 'service_text' => __('New tour','traveler')]); ?>
    <div id="modern-search-result" class="modern-search-result" data-layout="6">
        ...
        if($query->have_posts()) {
            while ($query->have_posts()) {
                $query->the_post();
                echo '<div class="col-12 col-md-6 col-lg-4 item-service">';
