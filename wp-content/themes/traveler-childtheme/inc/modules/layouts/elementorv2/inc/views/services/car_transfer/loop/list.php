...
?>
    <div class="services-item list item-elementor booking-item" itemscope itemtype="https://schema.org/RentalCarReservation" data-format="<?php echo TravelHelper::getDateFormatMoment() ?>, hh:mm A" data-date-format="<?php echo TravelHelper::getDateFormatMoment() ?>" data-time-format="hh:mm A"
        ...
        <form class="item
        service-border form-booking-car-transfer st-border-radius">
            ...
            <div class="content-item">
                <div class="content-item-left">
                    ...
                    ?>
                    <h4 class="title" itemprop="name"><?php  echo get_the_title($transfer_from). " to " . get_the_title($transfer_to); ?></h4>
                    <div class="car-equipments d-flex align-items-start justify-content-start clearfix">
                        <div class="item d-flex flex-column" data-bs-toggle="tooltip" title="<?php echo esc_attr__('Passenger', 'traveler'); ?>">
                            ...
                            <span class="text text-center">Max.</span>
                        </div>
                    ...
                    <?php
                            ...
                            if(isset( $get_transfer->has_title)){
                                 $transfer_title = $get_transfer['title'];
                            }
                            // if(isset($transfer_from) && isset($transfer_to) && !empty($transfer_from) && !empty($transfer_to)){
                                //echo get_the_title($transfer_from). " > " . get_the_title($transfer_to);
                            // }
                            ...
                            <?php } ?>
                    <div class="booking-item-features button booking-item-features-small clearfix">
                        <div class="st-choose-datetime">
                            <a class="st_click_choose_datetime_transfer " type="button"
                                data-target="#st_click_choose_datetime" aria-expanded="true"
                        ...
                        <div class="sroom-extra-service">
                            <a class="st_click_choose_service_transfer" type="button"
                                ...
                                <?php echo __('Baby seats? ', 'traveler'); ?> <i class="fa fa-angle-down arrow"></i>
                            </a>
                            ...
                            <div class="st-tooltip form-service" id="extra-service-sroom-<?php echo get_the_ID(); ?>">
                                    <div class="st-modal-dialog">
                                        ...
                                        ?>
                                        <div class="st-modal-header">Extra Services</div>
