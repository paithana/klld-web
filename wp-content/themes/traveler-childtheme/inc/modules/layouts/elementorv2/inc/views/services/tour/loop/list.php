    ...
    <div class="item service-border st-border-radius">
        <div class="featured-image">
            ...
            <a href="<?php echo esc_url($url); ?>">
                ...
                if(has_post_thumbnail()){
                    the_post_thumbnail(array(450, 300), array('alt' => TravelHelper::get_alt_image(), 'class' => 'img-responsive', 'itemprop'=>"photo"));
                }else{
        ...
        <div class="content-item">
            ...
            <div class="content-item-right">
                ...
                <div class="h-100 w-100 text-center d-flex align-content-between flex-wrap">
                    <div class="st-list-top w-100">
                        ...
                        <div class="price-wrapper d-none d-sm-block d-md-block d-lg-block service-type">
                            <?php
                    ...
                    <div class="st-list-footer w-100">
                        <div class="price-wrapper w-100 service-type d-sm-block d-md-block d-lg-block" itemprop="priceRange">
