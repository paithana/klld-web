...
<div class="destination-search border-right">
    <div id="dropdown-destination-from" class="form-group d-flex align-items-center form-extra-field dropdown field-detination field-detination-from dropdown-toggle <?php if ( $has_icon ) echo 'has-icon' ?>"  data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="true">
        <?php
        if ( $has_icon ) {
        ...
        <div class="st-form-dropdown-icon" >
            ...
            <div class="render">
                ...
                ?>
                <input type="text" touchend="stKeyupsmartSearch(this)" autocomplete = "off" id="transfer_from_name" name="transfer_from_name" value="<?php echo esc_attr($location_name); ?>" placeholder = "<?php echo esc_attr($placeholder);?>" data-post-type="st_car" data-text-no="<?php echo esc_html__('No locations...', 'traveler') ?>"/>
            </div>
