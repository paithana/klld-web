...
while (have_posts()): the_post();
    ...
    <div id="st-content-wrapper" class="st-style-4 st-style-elementor st-single-tour st-single-tour-<?php echo esc_attr($style_single);?>" itemscope itemtype="https://schema.org/Tour">
        ...
        <div class="container-fluid">
            <?php echo stt_elementorv2()->loadView('services/common/single/gallery-2', array('style' => 'slider')) ?>
        </div>
        ...
        <div class="container st-single-service-content">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                        ...
                        <div class="hotel-target-book-mobile d-flex justify-content-between align-items-center">
                            <div class="price-wrapper">
                                <div id="mobile-price" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                                    ...
                                    <meta itemprop="price" content="<?php echo (float)STTour::get_info_price()['price']; ?>" />
					...
					echo '<div class="count-review" name="count-review">'.$count_review.'</div>';
					echo '<div class="avg-review" name="avg-review">'.$avg.'</div>';
                                        ?>
