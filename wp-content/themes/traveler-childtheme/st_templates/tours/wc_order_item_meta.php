...
<ul class="wc-order-item-meta-list">
    ...
    <?php endif ;?>
        ...
        <?php endif; ?>
        <!-- Guest Name -->
        <?php if($item_data['_st_guest_name']) { ?>
            <li>
                <p><?php echo __("Guest Name"  ,'traveler') .": "; ?></p>
                <ul>
                    <?php
                    
                        foreach ($item_data['_st_guest_name'] as $key => $value) { ?>
                                <li style="padding-left: 10px "> 
                                    <?php
                                    //echo $key;
                                    $guest_title = $item_data['_st_guest_title'][$key];
                                    $guest_name = $item_data['_st_guest_name'][$key];
                                    echo strtoupper($guest_title." ".$guest_name); //esc_html($guest_title," ",$guest_name) ;
                                    ?>
                                </li>
                        <?php }
                    ?>
