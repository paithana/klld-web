        ...
        this.fullCalendarOptions = {
            ...
            select: function ({
                ...
                if (moment(start).isBefore(moment(), 'day') ||
                    ...
                    var check_in = moment(start).utcOffset(zone).format(String(st_params.date_format_calendar || "DD/MM/YYYY").toUpperCase());
                    var check_out = moment(end).utcOffset(zone).subtract(1, 'day').format(String(st_params.date_format_calendar || "DD/MM/YYYY").toUpperCase());
